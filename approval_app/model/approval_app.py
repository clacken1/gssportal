...
class ApprovalApp(models.Model):
    ...
    job_task=fields.One2many('task.description','app_id')
    stage_id=fields.Many2one('approval.stage',group_expand='_read_group_stage_ids')

    @api.model
    def _read_group_stage_ids(self, stages, domain, order):
        return self.env['approval.stage'].search([])
